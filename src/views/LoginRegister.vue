    ...
    <body class="background_image">
        <n-card class="card_bordered">
            <n-grid y-gap="12" :cols="1">
                ...
                <n-grid-item>
                    <n-gradient-text type="info" size=20 style="display:inline-block; margin-right: 5%;">
                        用户名
                    </n-gradient-text>
                    <n-input size="large" round placeholder="请输入用户名" style="width:80%;display:inline-block">
                    </n-input> 
                </n-grid-item>
                <n-grid-item>
                    <n-gradient-text type="info" size=20 style="display:inline-block; margin-right: 8%;">
                        密码
                    </n-gradient-text>
                    <n-input size="large" round placeholder="请输入密码" style="width:80%;display:inline-block">
                    </n-input> 
                </n-grid-item>
                <n-grid-item>
                    <n-button type="success" style="margin-right:10%">
                        登录
                    </n-button>
